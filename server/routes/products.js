...
ProductRouter.get('/auth',authentication,authorization,ProductController.showProductsUsers)
ProductRouter.get('/:id',ProductController.showProductsById)
ProductRouter.post('/add',authentication,authorization,ProductController.addProducts)
